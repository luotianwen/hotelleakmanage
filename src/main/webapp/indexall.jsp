...
<head>
	<title>农场管理系统 - Powered By JeeSite</title>
...
<script type="text/javascript">
    ...
    myChart.on('click', function(params) {
        if(null==params.value){
            location.href = "${pageContext.request.contextPath}${fns:getAdminPath()}/map/province";
        }
    });

</script>
<style>
	body{background-color:#99cdff;width:100%;height:100%;background-size:cover;}
</style>

</head>
<body>
	
<input type="hidden" id="geoCoordData" value="">
<input type="hidden" id="geoCoordMap" value="">
