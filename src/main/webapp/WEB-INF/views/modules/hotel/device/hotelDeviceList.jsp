...
<ul class="nav nav-tabs">
    ...
    --%></ul>
<form:form id="searchForm" modelAttribute="hotelDevice" action="${ctx}/hotel/device/hotelDevice/" method="post"
...
<table id="contentTable" class="table table-striped table-bordered table-condensed">
    ...
    <tr>
        ...
        <th>更新时间</th>
        <th>备注信息</th>
        <shiro:hasPermission name="hotel:device:hotelDevice:edit">
            <th>操作</th>
        </shiro:hasPermission>
    </tr>
    </thead>
        ...
        <tr>
            ...
            <shiro:hasPermission name="hotel:device:hotelDevice:edit">
                <td>
                    ...
                    <a href="${ctx}/hotel/device/hotelDevice/delete?id=${hotelDevice.id}"
                       onclick="return confirmx('确认要删除该设备管理吗？', this.href)">删除</a>
                </td>
            </shiro:hasPermission>
        </tr>
    </c:forEach>
