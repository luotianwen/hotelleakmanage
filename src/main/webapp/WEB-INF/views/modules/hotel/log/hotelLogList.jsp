	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead>
			<tr>
				...
				<th>离开时间</th>
				<th>房间号</th>
				<shiro:hasPermission name="hotel:log:hotelLog:edit"><th>操作</th></shiro:hasPermission>
			</tr>
		</thead>
		<tbody>
		<c:forEach items="${page.list}" var="hotelLog">
			<tr>
				...
				<shiro:hasPermission name="hotel:log:hotelLog:edit"><td>
    				<a href="${ctx}/hotel/log/hotelLog/form?id=${hotelLog.id}">修改</a>
					<a href="${ctx}/hotel/log/hotelLog/delete?id=${hotelLog.id}" onclick="return confirmx('确认要删除该酒店日志吗？', this.href)">删除</a>
