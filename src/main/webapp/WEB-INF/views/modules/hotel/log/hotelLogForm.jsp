...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/hotel/log/hotelLog/">酒店日志列表</a></li>
		<li class="active"><a href="${ctx}/hotel/log/hotelLog/form?id=${hotelLog.id}">酒店日志<shiro:hasPermission name="hotel:log:hotelLog:edit">${not empty hotelLog.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="hotel:log:hotelLog:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="hotelLog" action="${ctx}/hotel/log/hotelLog/save" method="post" class="form-horizontal">
		...
		<div class="form-actions">
			<shiro:hasPermission name="hotel:log:hotelLog:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
