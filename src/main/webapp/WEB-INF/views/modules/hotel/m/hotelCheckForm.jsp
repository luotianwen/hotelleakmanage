...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/hotel/m/hotelCheck/">入住管理列表</a></li>
		<li class="active"><a href="${ctx}/hotel/m/hotelCheck/form?id=${hotelCheck.id}">入住管理<shiro:hasPermission name="hotel:m:hotelCheck:edit">${not empty hotelCheck.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="hotel:m:hotelCheck:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="hotelCheck" action="${ctx}/hotel/m/hotelCheck/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			<div class="controls">
				<img id="imgs" src="${hotelCheck.phos}">
			</div>
		</div>
		<div class="control-group">
		...
		<div class="form-actions">
			<shiro:hasPermission name="hotel:m:hotelCheck:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
