...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/hotel/m/hotelDevice/">设备管理列表</a></li>
		<li class="active"><a href="${ctx}/hotel/m/hotelDevice/form?id=${hotelDevice.id}">设备管理<shiro:hasPermission name="hotel:m:hotelDevice:edit">${not empty hotelDevice.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="hotel:m:hotelDevice:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="hotelDevice" action="${ctx}/hotel/m/hotelDevice/save" method="post" class="form-horizontal">
		...
		<div class="form-actions">
			<shiro:hasPermission name="hotel:m:hotelDevice:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
