	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="hotelCheck">
			<tr>
				...
				<shiro:hasPermission name="hotel:check:hotelCheck:edit"><td>
    				<a href="${ctx}/hotel/check/hotelCheck/form?id=${hotelCheck.id}">修改</a>
					<a href="${ctx}/hotel/check/hotelCheck/delete?id=${hotelCheck.id}" onclick="return confirmx('确认要删除该入住管理吗？', this.href)">删除</a>
