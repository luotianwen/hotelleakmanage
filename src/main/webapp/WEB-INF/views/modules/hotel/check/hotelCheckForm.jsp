...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/hotel/check/hotelCheck/">入住管理列表</a></li>
		<li class="active"><a href="${ctx}/hotel/check/hotelCheck/form?id=${hotelCheck.id}">入住管理<shiro:hasPermission name="hotel:check:hotelCheck:edit">${not empty hotelCheck.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="hotel:check:hotelCheck:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="hotelCheck" action="${ctx}/hotel/check/hotelCheck/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="hotel:check:hotelCheck:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
