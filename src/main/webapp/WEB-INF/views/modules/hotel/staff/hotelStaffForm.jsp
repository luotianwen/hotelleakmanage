...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/hotel/staff/hotelStaff/">酒店员工列表</a></li>
		<li class="active"><a href="${ctx}/hotel/staff/hotelStaff/form?id=${hotelStaff.id}">酒店员工<shiro:hasPermission name="hotel:staff:hotelStaff:edit">${not empty hotelStaff.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="hotel:staff:hotelStaff:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
